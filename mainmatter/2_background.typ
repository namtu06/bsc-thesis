...
Each programmed cell death mode is regulated by a characteristic network of genes and proteins @qian2024. Consequently, differential expression of genes participating in these pathways can provide insight into alterations in the underlying signaling mechanisms. By integrating differentially expressed genes with Gene Ontology enrichment and curated cell death pathway gene sets from dedicated pathway databases such as KEGG or Reactome, it becomes possible to identify which regulated cell death pathways are most strongly associated with each GBM molecular subtype.


== Mitochondrial function and respiratory complexes


== Multiomics and computational analysis of cancer
...
It is the main form of computation done in this thesis.
